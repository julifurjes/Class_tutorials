...
```{r}
#loading data
#setwd("Users/julifurjes/Documents/uni/Perception and Action/classes")
data_vision <- read_bulk("/Users/julifurjes/Documents/uni/Perception and Action/classes/Vision")
data_audition <- read_bulk("/Users/julifurjes/Documents/uni/Perception and Action/classes/Audition")
...
```{r}
########################## PLOTTING TIME ##################################
data_audition_correct <- filter(data_audition, accuracy == "true")
data_vision_correct <- filter(data_vision, accuracy == "true")

# AUDITION
data_audition_correct %>% 
  ggplot() +
...
plot_rt_vis <- data_vision_correct %>% 
...
plot_rt_aud <- data_audition_correct %>% 
   group_by(subject, congruency) %>%
   summarize(mean_rt = mean(rt)) %>%
  ggplot() + 
  aes(x=congruency, y=mean_rt, color=subject) + 
